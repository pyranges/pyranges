...
The pyranges library can create PyRanges from three common file formats, namely gtf/gff, bed and bam [^].
...
`read_bam` takes the arguments `mapq`, `required_flag`, `filter_flag`, which
have the default values 0, 0 and 1540, respectively.
