...
from tests.hypothesis.hypothesis_helper import dfs_min_single_chromosome
...
# better_dfs_min_single_chromosome = data_frames(index=indexes(dtype=np.int64, min_size=1, unique=True),
