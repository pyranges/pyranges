...
use genomics library for Python. It provides the data structure PyRanges, a port
of GenomicRanges, the foundational genomics datastructure in the R bioconductor
project.
...
- programming-free multi-core support; *all methods, both built-in and
  user-defined, can easily be called in parallel*
- full Python science stack interoperability; *PyRanges are just pandas DataFrames under the hood*
- user-friendly API; *pyranges fills the holes in the GenomicRanges API*
